...
public class DeliveryDetailFragment extends Fragment {
    ...
    private ImageView ivDelivery, ivButton;
    ...
    private Switch swDeliveryState;
    ...
    private void showDelivery() {
        ...
        if (deliveryDetail.getDelState() == 0) {
            tvDeliveryState.setText("離職外送員");
            tvDeliveryState.setTextColor(Color.RED);
            swDeliveryState.setChecked(false);
        } else if (deliveryDetail.getDelState() == 1) {
            tvDeliveryState.setText("有效外送員");
            swDeliveryState.setChecked(true);
            tvDeliveryState.setTextColor(Color.BLUE);
        }else if (deliveryDetail.getDelState() == 2) {
            tvDeliveryState.setText("停權外送員");
            swDeliveryState.setChecked(true);
            tvDeliveryState.setTextColor(Color.RED);
        }
