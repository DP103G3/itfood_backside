...
public class ShopDishDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_shop_dish_detail, container, false);
    }
        ...
        btUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Navigation.findNavController(view)
                        .navigate(R.id.action_shopDishDetailFragment_to_shopDishUpdateFragment, bundle);
            }
        });
