...
public class ShopAddDishFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        activity.setTitle(R.string.textShopAddDishLishTitle);
        return inflater.inflate(R.layout.fragment_shop_add_dish, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (bundle == null || bundle.getSerializable("shop") == null) {
            Common.ShowToast(activity, R.string.textSystemError);
