package tw.dp103g3.itfood_backside.task;
...
public class MemberImageTask extends AsyncTask<Object, Integer, Bitmap> {
    private final static String TAG = "MemberImageTask";
    private String url;
    ...
    // 取單張圖片
    public MemberImageTask(String url, int id, int imageSize) {
        this(url, id, imageSize, null);
    }

    // 取完圖片後使用傳入的ImageView顯示，適用於顯示多張圖片
    public MemberImageTask(String url, int id, int imageSize, ImageView imageView) {
        this.url = url;
        this.id = id;
