...
public class MemberNameUpdateFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        activity.setTitle(R.string.textMemberNameUpdateTitle);
        return inflater.inflate(R.layout.fragment_member_name_update, container, false);
    }
